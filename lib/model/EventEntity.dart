import 'dart:convert' as httpJson;
...
class Data {
	...
	Map<String,dynamic> secondSubject;
	Map<String,dynamic> thirdSubject;
	Actor actor;
	Book book;
	String sSerializer;

	Data({this.id, this.spaceId, this.userId, this.eventType, this.subjectType,this.subEventsCount, this.subjectId, this.secondSubjectType, this.secondSubjectId, this.thirdSubjectType, this.thirdSubjectId, this.actorId, this.bookId, this.params, this.createdAt, this.updatedAt, this.subject, this.secondSubject, this.thirdSubject, this.actor, this.book, this.sSerializer});
	...
	Data.fromJson(Map<String, dynamic> json) {
		...
		subEventsCount = json['subEventsCount'];
		...
		subject = json['subject'] != null ? Map.from(json['subject']) : null;
		secondSubject = json['second_subject'] != null ? Map.from(json['second_subject']) : null;
		thirdSubject = json['third_subject'] != null ? Map.from(json['third_subject']) : null;
		actor = json['actor'] != null ? new Actor.fromJson(json['actor']) : null;
		book = json['book'] != null ? new Book.fromJson(json['book']) : null;
		if (json['subjects'] != null) {
			subjects = new List<Map<String,dynamic>>();
			json['subjects'].forEach((v) { subjects.add(v); });
		}
	...
	Map<String, dynamic> toJson() {
		...
		data['subEventsCount'] = this.subEventsCount;
		...
		if (this.subject != null) {
			data['subject'] = this.subject.toString();
		}
		if (this.secondSubject != null) {
			data['second_subject'] = this.secondSubject.toString();
		}
		if (this.thirdSubject != null) {
			data['third_subject'] = this.thirdSubject.toString();
		}
		if (this.actor != null) {
